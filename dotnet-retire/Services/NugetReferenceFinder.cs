...
{
    public class NugetReferenceFinder
    {
        private readonly IFileService _fileService;

        public NugetReferenceFinder(IFileService fileService)
        {
        ...
        {
            var fileContents = _fileService.GetProjectAssetsJsonContents();
            if (string.IsNullOrEmpty(fileContents))
            {
                fileContents = _fileService.GetProjectLockJsonContents();
            }
